...
<head>
    ...
    <link style="height:24px;" rel="icon" href="Volvo.jpg">
...
<body style="padding-bottom:200px;">
    ...
    <div class="video_grid">
          <?php
         $sql = "SELECT * FROM `vehicles` WHERE `branchphone`='0731245622'";
       ...
       <div class='container1'>
            ...
            <div class='details'>
              <div class='logo-cont'> <img class='img'src='Volvo.jpg' alt=''>
          </div>
