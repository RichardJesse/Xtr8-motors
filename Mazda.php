...
<head>
    ...
    <link style="height:24px;" rel="icon" href="Mazda logo.png">
...
<body style="padding-bottom:200px;">
    ...
    <div class="video_grid">
          <?php
         $sql = "SELECT * FROM `vehicles` WHERE `branchphone`='0745665412'";
       ...
       <div class='container1'>
            ...
            <div class='details'>
              <div class='logo-cont'> <img class='img'src='Mazda logo.png' alt=''>
          </div>
