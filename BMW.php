...
<head>
    ...
    <link style="height:24px;" rel="icon" href="BMW.jpg">
...
<body style="padding-bottom:200px;">
    ...
    <div class="video_grid">
          <?php
         $sql = "SELECT * FROM `vehicles` WHERE `branchphone`='0710820321'or `branchphone`='0720810321'";
       ...
       <div class='container1'>
            ...
            <div class='details'>
              <div class='logo-cont'> <img class='img'src='BMW.jpg' alt=''>
          </div>
