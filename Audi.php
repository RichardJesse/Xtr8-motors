...
<head>
    ...
    <link style="height:24px;" rel="icon" href="Audi2.jpg">
...
<body style="padding-bottom:200px;">
    <div class="header">
        ...
        <div class="rightsection">
            <a href="Audi.php"  class="active">Home</a>
            
            <a href="logout.html">Logout</a>
        </div>
    </div>
        <div class="sidebar">
            <div class="sidebar-link" class="active">
             <img src="Audi2.jpg">
    ...
    <div class="video_grid">
          <?php
         $sql = "SELECT * FROM `vehicles` WHERE `branchphone`='0723421312'";
       ...
       <div class='container1'>
            ...
            <div class='details'>
              <div class='logo-cont'> <img class='img'src='Audi2.jpg' alt=''>
          </div>
