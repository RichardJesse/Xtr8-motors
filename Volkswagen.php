...
<head>
    ...
    <link style="height:24px;" rel="icon" href="Volkswagen logo.jpg">
...
<body style="padding-bottom:200px;">
    ...
    <div class="video_grid">
          <?php
         $sql = "SELECT * FROM `vehicles` WHERE `branchphone`='0790120345'";
       ...
       <div class='container1'>
            ...
            <div class='details'>
              <div class='logo-cont'> <img class='img'src='Volkswagen logo.jpg' alt=''>
          </div>
