...
<head>
    ...
    <link style="height:24px;" rel="icon" href="Nissan logo.jpg">
...
<body style="padding-bottom:200px;">
    ...
    <div class="video_grid">
          <?php
         $sql = "SELECT * FROM `vehicles` WHERE `branchphone`='0798143246'";
       ...
       <div class='container1'>
            ...
            <div class='details'>
              <div class='logo-cont'> <img class='img'src='Nissan logo.png' alt=''>
          </div>
